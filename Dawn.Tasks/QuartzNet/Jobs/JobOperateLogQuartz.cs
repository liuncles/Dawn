...
namespace Dawn.Tasks.QuartzNet.Jobs
{
    ...
    {
        private readonly ISysOperateLogServices _operateLogServices;
        private readonly IWebHostEnvironment _environment;

        public JobOperateLogQuartz(ISysOperateLogServices operateLogServices, ITasksQzServices tasksQzServices, IWebHostEnvironment environment)
        {
        ...
        public async Task Run(IJobExecutionContext context)
        {
            ...
            var operateLogs = new List<SysOperateLog>() { };
            excLogs.ForEach(m =>
            {
                operateLogs.Add(new SysOperateLog()
                {
                    LogTime = m.Datetime,
            ...
            {
                var logsIds = await _operateLogServices.AddAsync(operateLogs);
            }
        }
    }
}
