...
namespace Dawn.Tasks.QuartzNet
{
    ...
    public class SchedulerCenterServer : ISchedulerCenterServer
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<MsgEntity<string>> StartScheduleAsync()
        {
            var result = new MsgEntity<string>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<MsgEntity<string>> StopScheduleAsync()
        {
            var result = new MsgEntity<string>();
            try
            {
        ...
        /// <returns></returns>
        public async Task<MsgEntity<string>> AddScheduleJobAsync(TasksQz tasksQz)
        {
            var result = new MsgEntity<string>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<MsgEntity<string>> StopScheduleJobAsync(TasksQz sysSchedule)
        {
            var result = new MsgEntity<string>();
            try
            {
        ...
        /// <returns></returns>
        public async Task<MsgEntity<string>> ResumeJob(TasksQz sysSchedule)
        {
            var result = new MsgEntity<string>();
            try
            {
        ...
        /// <param name="sysSchedule"></param>
        /// <returns></returns>
        public async Task<MsgEntity<string>> PauseJob(TasksQz sysSchedule)
        {
            var result = new MsgEntity<string>();
            try
            {
        ...
        /// <param name="tasksQz"></param>
        /// <returns></returns>
        public async Task<MsgEntity<string>> ExecuteJobAsync(TasksQz tasksQz)
        {
            var result = new MsgEntity<string>();
            try
            {
