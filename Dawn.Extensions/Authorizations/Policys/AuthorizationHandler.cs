...
namespace Dawn.Extensions.Authorizations
{
    ...
    public class AuthorizationHandler : AuthorizationHandler<AuthorizationRequirement>
    {
        ...
        private readonly ISysRoleModulesAuthorizeServices _roleModulesAuthorizeServices;
        ...
        /// <param name="roleModuleAuthorizeServices"></param>
        /// <param name="accessor"></param>
        public AuthorizationHandler(IAuthenticationSchemeProvider schemes, ISysRoleModulesAuthorizeServices roleModuleAuthorizeServices, IHttpContextAccessor accessor)
        {
            _accessor = accessor;
            Schemes = schemes;
            _roleModulesAuthorizeServices = roleModuleAuthorizeServices;
        }
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, AuthorizationRequirement requirement)
        {
            ...
            {
                var data = await _roleModulesAuthorizeServices.RoleModulesMaps();
                ...
                requirement.Authorizations = list;
            }
            ...
            if (httpContext != null)
            {
                ...
                if (defaultAuthenticate != null)
                {
                    ...
                    if (result?.Principal != null || isTestCurrent)
                    {
                        ...
                        var permisssionRoles = requirement.Authorizations.Where(w => currentUserRoles.Contains(w.Role));
