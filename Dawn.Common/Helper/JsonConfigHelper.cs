...
namespace Dawn.Commons.Helper
{
    ...
    public class JsonConfigSettings
    {
        ...
        public static List<string> NacosServerAddresses
        {
            get
            {
                return JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").ServerAddresses;
            }
        }
        ...
        public static int NacosDefaultTimeOut
        {
            get
            {
                return JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").DefaultTimeOut;
            }
        }
        ...
        public static string NacosNamespace
        {
            get
            {
                return JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").Namespace;
            }
        }
        ...
        public static string NacosServiceName
        {
            get
            {
                return JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").ServiceName;
            }
        }
        ...
        public static int ListenInterval
        {
            get
            {
                return JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").ListenInterval;
            }
        }
        ...
        public static string NacosIp
        {
            get
            {
                return JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").Ip;
        ...
        public static int NacosPort
        {
            get
            {
                return int.Parse(JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").Port);
            }
        }
        ...
        public static bool NacosRegisterEnabled
        {
            get
            {
                return JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").RegisterEnabled;
            }
        }
        ...
        public static Dictionary<string, string> NacosMetadata
        {
            get
            {
                return JsonConfigHelper.GetAppSettings<NacosConfigDto>(Configuration, AppSettingsFileName, "nacos").Metadata;
            }
        }
