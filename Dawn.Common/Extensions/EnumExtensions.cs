...
namespace Dawn.Commons.Extensions
{
    /// <summary>
    /// 枚举的扩展方法
    /// </summary>
    public static class EnumExtensions
    {
        ...
        private static List<EnumDto> setEnumToList(Type enumType)
        {
            ...
            foreach (var e in Enum.GetValues(enumType))
            {
                ...
                {
                    EnumAttachedAttribute? ea = attacheds[0] as EnumAttachedAttribute;
                    //m.Attached = aa;
                    m.TagType = ea.TagType;
                    m.Description = ea.Description;
                    m.Icon = ea.Icon;
                    m.IconColor = ea.IconColor;
                }
