namespace Dawn.Commons.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Dawn.IS4.API.Controllers", "Dawn.IS4.API.Controllers", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Dawn.Entities", "Dawn.Entities", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Dawn.IRepository", "Dawn.IRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Dawn.IServices", "Dawn.IServices", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Dawn.Repository", "Dawn.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Dawn.Services", "Dawn.Services", tableNames, "", isMuti);
            return true;
        }
                 ...
                 .SettingClassTemplate(p => p =
                    ...
                    namespace " + strNameSpace + @"
                    {
                         ...
                         public class {ClassName}Controller : ControllerBase
                        {
                                ...
                                [HttpGet]
                                public async Task<MsgEntity<PageModel<{ClassName}>>> Get(int page = 1, string key = """",int intPageSize = 50)
                                {
                                    ...
                                    return new MsgEntity<PageModel<{ClassName}>>()
                                    {
                                        msg = ""获取成功"",
                                        success = true,
                                ...
                                [HttpGet(""{id}"")]
                                public async Task<MsgEntity<{ClassName}>> Get(string id)
                                {
                                    return new MsgEntity<{ClassName}>()
                                    {
                                        msg = ""获取成功"",
                                        success = true,
                                ...
                                [HttpPost]
                                public async Task<MsgEntity<string>> Post([FromBody] {ClassName} request)
                                {
                                    var data = new MsgEntity<string>();
                                ...
                                [HttpPut]
                                public async Task<MsgEntity<string>> Put([FromBody] {ClassName} request)
                                {
                                    var data = new MsgEntity<string>();
                                ...
                                [HttpDelete]
                                public async Task<MsgEntity<string>> Delete(int id)
                                {
                                    var data = new MsgEntity<string>();
            ...
            )
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                 ...
                 .SettingClassTemplate(p => p =
                    @"using Dawn.Repository.Base;
                    using Dawn.Entities" + (isMuti ? "." + ConnId + "" : "") + @";
                    ...
                    namespace " + strNameSpace + @"
                    {
	                    ...
	                    /// </summary>	
                        public interface I{ClassName}Repository : IRepositoryBase<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
                        {
                        }
                    }")
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
                     ...
                     {	
	                     ...
	                     /// </summary>	
                         public interface I{ClassName}Services :IServicesBase<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	                     {
                         }
                     }")
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
                     @"using Dawn.Repository" + (isMuti ? "." + ConnId + "" : "") + @";
                     using Dawn.Repository.UnitOfWork;
                     using Dawn.Entities" + (isMuti ? "." + ConnId + "" : "") + @";
                     using Dawn.Repository.Base;
                     ...
                     namespace " + strNameSpace + @"
                     {
	                     ...
	                     /// </summary>
                         public class {ClassName}Repository : RepositoryBase<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
                         {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
                     @"
                     using Dawn.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
                     using Dawn.Entities" + (isMuti ? "." + ConnId + "" : "") + @";
                     ...
                     namespace " + strNameSpace + @"
                     {
                         public class {ClassName}Services : ServicesBase<{ClassName}>, I{ClassName}Services" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
                         {
                             private readonly IRepositoryBase<{ClassName}> _dal;
                             public {ClassName}Services(IRepositoryBase<{ClassName}> dal)
                             {
                                 this._dal = dal;
                                 base.BaseDal = dal;
                             }
