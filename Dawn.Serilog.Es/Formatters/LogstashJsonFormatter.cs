using Dawn.Serilog.Es.HttpInfo;
...
namespace Dawn.Serilog.Es.Formatters
{
    public class LogstashJsonFormatter : ITextFormatter
    {
        ...
        private static void FormatContent(LogEvent logEvent, TextWriter output)
        {
            ...
            // 读取相关配置
            var logConfigRootDTOInfo = JsonConfigUtils.GetAppSettings<LogConfigDto>(AppSettingsFileNameConfig.AppSettingsFileName, "LogFiedOutPutConfigs");
